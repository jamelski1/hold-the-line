...
NEGATIVE_QUERIES: list[str] = [
    ...
    "Who wrote 'Beloved'?",
    "What is the longest-reigning monarch in British history known for?",
    "Define 'apoptosis' in cell biology.",
    "Who is the author of 'The Hobbit'?",
    "What is the capital of Norway?",
    "Name the gas plants release during photosynthesis.",
    "What does 'CPU' stand for?",
    "Define 'tessellation' in geometry.",
    ...
    "Name the most spoken language in the world by native speakers.",
    "What is the area of a rectangle with sides 7 and 4?",
    ...
    "Define 'homologous structures' in biology.",
    "Who wrote 'A Room of One's Own'?",
    "Name the only continent without reptiles or snakes.",
    ...
    "Define 'enzyme' in biochemistry.",
    "Who is the inventor of the cotton gin?",
    "What is the capital of New Zealand?",
    "Define 'cardinal' versus 'ordinal' numbers.",
    "Who wrote 'Things Fall Apart'?",
    "Name the strongest natural material on Earth.",
    "What is the meaning of 'verbose'?",
    "Define 'matrix' in linear algebra.",
    "Who painted 'Las Meninas'?",
    "What is the capital of Denmark?",
    "Define 'ionic bond'.",
    "Who wrote 'The Bell Jar'?",
    "Name the smallest ocean on Earth.",
]
